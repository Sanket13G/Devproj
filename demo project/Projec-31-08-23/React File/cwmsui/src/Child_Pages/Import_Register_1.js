...
export default function Import_Register_1(props) {
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-8">
                                                <div className="text-center">
                                                    <Button variant="success" className='btnwidth' style={{ marginRight: 10 }}>Search</Button>
                                                    <Button variant="warning" className='btnwidth' >Reset</Button>
                                                </div>
                                            </div>
